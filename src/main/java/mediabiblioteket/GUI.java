...
/**
 * Huvudfönstret i Bibliotekssystemet som användaren interagerar med för att
 * bl.a. söka efter olika mediatyper och låna en specifik media
 */
public class GUI extends Application {
	 ...
	 * med de olika grafiska komponenterna som användaren kan interagera med via
	 * Controller klassen.
	 * 
	 * @return
	 */
	...
	public Scene loginScene() {
		...
		logInScene = new Scene(vBox, 400, 100);
	...
	public void mediaScene() {
			...
			protected void updateItem(String item, boolean empty) {
				...
				if (empty || item == null) {
					...
					if (item.contains("- Borrowed")) {
						if (searchPage) setStyle("-fx-background-color: rgb(255,153,153);");
		...
		theScroller.setPrefSize(500, 800);
	...
	/**
	 * Kollar vid inloggningen ifall om en person finns registrerad i
	 * Bibliotekssystemet.
	 * 
	 * @param userName. Personnummer för låntagaren @return. True om personnummer
	 *                  existerar, annars False.
	 */
	...
	/**
	 * Lyssnar på Event ifrån användaren.Här kan låntagaren välja att 1.Söka bland
	 * media 2.Söka djupgående information om ett visst media 3.Låna ett visst media
